sap.ui.define([
	...
	return BaseController.extend("prueba.TestSuccesFactorsApss.controller.Master", {
		...
		onInit : function () {
			...
			this._oGroupFunctions = {
				totalTeamSize : function(oContext) {
					var iNumber = oContext.getProperty('totalTeamSize'),
						key, text;
					if (iNumber <= 20) {
						key = "LE20";
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "prueba.TestSuccesFactorsApss.view.ViewSettingsDialog",
					controller: this
		...
		onConfirmViewSettingsDialog : function (oEvent) {
			...
			aFilterItems.forEach(function (oItem) {
				switch (oItem.getKey()) {
					case "Filter1" :
						aFilters.push(new Filter("totalTeamSize", FilterOperator.LE, 100));
						break;
					case "Filter2" :
						aFilters.push(new Filter("totalTeamSize", FilterOperator.GT, 100));
						break;
					default :
						break;
				}
